        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-row">
              ...
              <div class="form-grou col-6">
                  <label>Password</label>
                  <input name = "password_mhs" type="password" class="form-control" value="<?php echo $bio['password_mhs']; ?>">
              </div>
            </div>
        ...
        <div class="modal-content">
            ...
            ?>
                ...
                <div class="card-body box-profile">
                  ...
                  <center>
                  <img src="img/foto/<?php echo $row['foto_mhs'];?>" alt="Foto" width="100" class="rounded-circle"></center><br>
                    <h3 class="profile-username text-center"><?php echo $row['nama_mhs'] ?></h3>
                        <ul class="list-group list-group-unbordered mb-3">
                          ...
                          <li class="list-group-item">
                            <b>Tanda Tangan</b> <img src="img/ttd/<?php echo $row['ttd_mhs'];?>" alt="Foto" width="50px" height="50px" class="float-right">
                          </li>
                        </ul>
                </div>
