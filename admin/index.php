...
<?php
    $index = mysqli_query($koneksi, "SELECT * FROM tb_pengajuan");
    $jumlah_pengajuan = mysqli_num_rows($index);
?>
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="tb_pengajuan/index.php" class="small-box-footer">More info <i class="fas fa-arrow-alt-circle-right"></i></a>
                    </div>
                </div>
            <div class="row">
                <div class="col-5">
                    <div class="card card-secondary">
                        ...
                        <div class="card card-secondary card-outline">
                            <div class="card-body box-profile">
                                ...
                                <a href="tb_pegawai/edit_user.php" class="btn btn-secondary btn-block"><b>Edit Profil</b></a>
                            </div>
                            <!-- /.card-body -->
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Syarat dan Ketentuan Pengajuan Peminjaman</a></li>
                                <ul>
                            </div>
                            <div class="card-body">
