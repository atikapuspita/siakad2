...
<div class="wrapper">
  ...
  <?php
      ...
      $user = mysqli_query($koneksi, "SELECT * FROM tb_verifikasi INNER JOIN tb_pengajuan ON tb_pengajuan.id_pengajuan = tb_verifikasi.id_pengajuan
      INNER JOIN tb_mahasiswa ON tb_pengajuan.npm = tb_mahasiswa.npm");
  ?>
