...
if(isset($_POST['tambah'])){
  ...
  //Membuat Variabel untuk menyimpan Foto atau Gambar
	...
	$folder="img/foto_mahasiswa/$nama_foto_mhs";
	...
	$folder="img/ttd_mahasiswa/$nama_ttd_mhs";
...
$query = "INSERT INTO tb_mahasiswa (`npm`, `id_jurusan`, `id_doswal`, `username_mhs`, `password_mhs`, `nama_mhs`, `jk`, `thn_angkatan`,`ttl`, `id_prodi`,
         `alamat`, `no_telp_mhs`, `foto_mhs`,`ttd_mhs`) 
         VALUES ('$npm', '$id_jurusan', '$id_doswal', '$username_mhs', '$password_mhs', '$nama_mhs', '$jk', '$thn_angkatan','$ttl', '$id_prodi',
